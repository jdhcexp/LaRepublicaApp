<template>
    <ScrollView>
        <WrapLayout backgroundColor="#fff" v-if="bannerExist">
            <StackLayout orientation="horizontal" class="company-indicators" v-for="(item, index) in quotes"
                :key="index">
                <Label :text="item.name" class="indicator" textWrap="true" />
                <Label :text="item.quoteValue.value" class="value" />
                <Label :text="item.quoteValue.percentageVariation" class="porcent"
                    :class="getIndicatorClass(item.quoteValue.variationType)" />
       ...
       <StackLayout orientation="horizontal" class="company-indicators">
            ...
            <GridLayout>
            <IndicatorsBar></IndicatorsBar>
        </GridLayout>
            <!-- <StackLayout>
                <ScrollView orientation="horizontal" height="32" class="indicators-bar">
                    <GridLayout
                        columns="auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto auto">
                        ...
                        <Image column="3" src="~/assets/icons/down.png" width="7" verticalAlignment="center"
                        ...
                        <Image column="7" src="~/assets/icons/up.png" width="7" verticalAlignment="center"
                            class="icon-indicator-bar" />
                        ...
                        <Label column="10" text="+$31,11" class="porcent-bar positive-indicator"
                            textWrap="true"></Label>
                        <Image column="11" src="~/assets/icons/up.png" width="7" verticalAlignment="center"
                            class="icon-indicator-bar" />
                        ...
                        <Label column="14" text="+1,57 %" class="porcent-bar negative-indicator"
                            textWrap="true"></Label>
                        <Image column="15" src="~/assets/icons/down.png" width="7" verticalAlignment="center"
                            class="icon-indicator-bar" />
                        ...
                        <Label column="18" text="-1,57 %" class="porcent-bar positive-indicator"
                            textWrap="true"></Label>
                        <Image column="19" src="~/assets/icons/up.png" width="7" verticalAlignment="center"
                            class="icon-indicator-bar" />
                        ...
                        <Label column="22" text="+$31,11" class="porcent-bar positive-indicator"
                            textWrap="true"></Label>
                        <Image column="23" src="~/assets/icons/up.png" width="7" verticalAlignment="center"
                            class="icon-indicator-bar" />
                    </GridLayout>
                </ScrollView>
            </StackLayout> -->
