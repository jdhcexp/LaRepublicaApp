...
// instagratrelloVue.config.silent = !__DEV__
...
var universalLinks = require('@nativescript-community/universal-links');

universalLinks.registerUniversalLinkCallback(function (link){
  console.log(link)
})
